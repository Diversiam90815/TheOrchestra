...
/*
 @brief             Struct holding information of the AudioSamples, such as Instrument Name, the individual note, the round robin instance,                   the dynmic of the recording and the actual buffer holding the audio samples
*/
struct Sample
{
